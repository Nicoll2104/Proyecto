...
const httpPedido = {
    ...
    postPedido: async (req , res )=>{
        try{
            const {fecha_creacion, fecha_entrega, instructor_encargado, subtotal, total, impuestos, ficha, usuario}=req.body;
            const pedidos = new pedido({fecha_creacion, fecha_entrega, instructor_encargado, subtotal, total, impuestos, ficha, usuario});
    ...
    putPedido: async (req,res) =>{
        ...
        try{
            const pedidos  = await pedido.findByIdAndUpdate(id, {fecha_creacion, fecha_entrega, instructor_encargado, subtotal, total, impuestos, ficha, usuario}, { new: true });
