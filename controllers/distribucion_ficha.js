const distribucion_ficha = require('../models/distribucion_ficha');
const Distribucion_presupuesto = require('../models/distribucion_presupuesto');
const Ficha = require('../models/ficha');

const httpDistribucionFicha = {
    getDisFichas: async (req, res) => {
        try {
            const distribuciones = await distribucion_ficha.find().populate('distribucion_presupuesto').populate('ficha');
