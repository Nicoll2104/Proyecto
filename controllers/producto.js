...
const httpProducto = {
    ...
    postProducto: async (req,res)=>{
        try{
            const {codigo, nombre, descripcion, unidad_medida,consumible,precio_unitario,iva,lote}=req.body;
            const productos = new producto({codigo, nombre, descripcion, unidad_medida,consumible,precio_unitario,iva,lote});
    ...
    putProducto: async (req,res) =>{
        ...
        try{
            const productos  =await producto.findByIdAndUpdate(id, { codigo, nombre, descripcion, unidad_medida,consumible,precio_unitario,iva,lote}, { new: true });
